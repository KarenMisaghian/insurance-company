...
public class Car implements Cloneable {
    ...
    public void print() {
        System.out.print(" Model: " + model + " Car Type: " + carType + " Manufacturing Year: " + manufacturingYear
                + " Price: ");
    ...
    public String toString() {
        return "Model: " + model + " Car Type: " + carType + " Manufacturing Year: " + manufacturingYear + " Price: "
