...
public class UITools {
    ...
    public static void addComprehensivePolicy(User user, String policyHolderName, int id, Car car, int numberOfClaims,
    ...
    public static void addThirdPartyPolicy(User user, String policyHolderName, int id, Car car, int numberOfClaims,
    ...
    public static void addUser(InsuranceCompany insuranceCompany, String name, int id, Address address,
            String password) {
    ...
    public static void addThirdPartyPolicy(InsuranceCompany insuranceCompany, int userID, String policyHolderName,
            int id, Car car, int numberOfClaims, MyDate expiryDate, String comments) {
        if (insuranceCompany.createThirdPartyPolicy(userID, policyHolderName, id, car, numberOfClaims, expiryDate,
                comments)) {
    ...
    public static void addComprehensivePolicy(InsuranceCompany insuranceCompany, int userID, String policyHolderName,
            int id, Car car, int numberOfClaims, MyDate expiryDate, int driverAge, int level) {
        if (insuranceCompany.createComprehensivePolicy(userID, policyHolderName, id, car, numberOfClaims, expiryDate,
                driverAge, level)) {
            System.out.println("The policy is added successfully");
        } else {
            System.out.println("The policy can't be added. A policy with the same ID exists");
    ...
    public static Car getCar() {
        ...
        return new Car(carModel, price, manufacturingYear, carType);
    }
