...
public class TestCase {
    public static void testCode(InsuranceCompany insuranceCompany) {
        double flatRate = 12;
        ...
        Car car1 = new Car("AUDI-A3", 24500, 2010, CarType.LUX);
        Car car2 = new Car("SRX", 34500, 2020, CarType.SUV);
        Car car3 = new Car("Camry", 14500, 2013, CarType.SED);
        Car car4 = new Car("AUDI-A1", 74500, 2020, CarType.LUX);
        ...
        // Address newAddress = new Address(newStreetNum, newStreetName, newSuburb,
        // newCity); // by using scanner
        ...
        // add 10% to the price of cars for all the policies this user owns and print
        // again
        ...
        // InsuranceCompany insuranceCompany = new InsuranceCompany("Hooman Company",
        // "admin", "admin", 20); // we get it as an input parameter now
        ...
        } else // login successfull
        {
            ...
            UITools.addUser(insuranceCompany, "Mark", 56236, new Address(9, "Wind St", "West Wollongong", "Wollongong"),
                    "pass123");
            ...
            // insuranceCompany.addPolicy(1, policy1); //wrong not checkign the output of
            // the boolean method
            ...
            // Add several policies to some users by calling createComprehensivePolicy() and
            ...
            UITools.addComprehensivePolicy(insuranceCompany, 12, "Sara", 1234, car4, 12, new MyDate(2021, 10, 18), 5,
                    4);
            ...
            // Ask customer to enter a userID and and print the user and all of his policies
            // by using methods inside insuranceCompany
            System.out.println("--------------------------------------");
            // Scanner scan = new Scanner(System.in);
            ...
            /*
             * Ask customer to enter a userID and policyID and find a policy with the given
             * policyID for that userID by calling findPolicy (int userID ,int policyID) and
             * then print the policy.
             */
            ...
            // Print the total payments for a given userID by calling calcTotalPayments (int
            // userID)
            // System.out.print("Enter a userID: ");
            // int userID = scan.nextInt();
            // System.out.printf("Total payments for this user: %.2f%n",
            ...
            // Call allPolicies() for the insuranceCompany and store it in an ArrayList and
            // print the list by using InsurancePolicy.printPolicies()
            ...
            System.out.printf("The Total Payment of users after 10 percent rise: %.2f%n",
                    insuranceCompany.calcTotalPayments());
            System.out.println("Print All the users after car price rise");
            insuranceCompany.print();

            System.out.println("Print a user after car price rise");
            // insuranceCompany.carPriceRise(user0.getUserID(),0.1); //wrong as it does not
            // check the output
            // UITools.carPriceRise(insuranceCompany,1345,0.1); //or
            UITools.carPriceRise(insuranceCompany, user3.getUserID(), 0.1);
            user3.print();

            // For a given userID and expiry date call filterByExpiryDate (int userID,
            // MyDate date), store the filtered list and print the list by using
            // InsurancePolicy.printPolicies()
            System.out.println("-----------------filter user policies by Expiry Date--------------------");
            ArrayList<InsurancePolicy> filteredByExpiryDatePolicies1 = insuranceCompany
                    .filterByExpiryDate(user3.getUserID(), new MyDate(2020, 7, 15));
            InsurancePolicy.printPolicies(filteredByExpiryDatePolicies1);
            System.out.println();

            // For a given car model and userID call insuranceCompany.filterByCarModel
            // (String carModel) and print the filtered list
            System.out.println("-----------------filter user policies by Car Model------------------");
            InsurancePolicy.printPolicies(insuranceCompany.filterByCarModel(user4.getUserID(), "Toyota")); // Without
                                                                                                           // the
                                                                                                           // seperate
                                                                                                           // list
            System.out.println();
            ...
            ArrayList<InsurancePolicy> filteredByExpriyDatePolicies = insuranceCompany
                    .filterByExpiryDate(new MyDate(2015, 6, 15));
            ...
            // Ask user to enter a date (year, month, and day) and call filterByExpiryDate
            // (MyDate date) and print the filtered list
            ...
            // ArrayList<InsurancePolicy> filteredList =
            // insuranceCompany.filterByExpiryDate(userDate);
            // InsurancePolicy.printPolicies(filteredList);

            // Find a user with the given ID (valid) and save it in a user object. Ask user
            // to provide a new address and change the current address for the given user
            System.out.println("--------------------------------------");
            ...
            System.out.println(
                    "---Report Total and average Payments for all Models with the report method with no parameters---");
            ...
            // or using the report with no parameter
            System.out.println(
                    "---Report Total and average Payments for all car models user 3: with the report method with no parameters---");
